...
For even more ability to reuse chunks of tests, you can save arbitrary
test segments as **fragments**, which can be inserted into a test at
any time.
...
This is a newer feature, so reach out to the team for guidance
on best usage.