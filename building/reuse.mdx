...
Then in the resulting test, you can modify the values used in the test by
...
[delete the steps](/building/editing#delete) after the point where the
...
and steps will be added to the end of the test. Here's what that looks
like:
...
any time. This is a newer feature, so reach out to the team for guidance
on best usage.